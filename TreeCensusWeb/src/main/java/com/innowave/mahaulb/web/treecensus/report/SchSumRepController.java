...
public class SchSumRepController {
	@Autowired
	...
	@RequestMapping(value = "/reportschemesummary", method = { RequestMethod.GET, RequestMethod.POST })
	public String diversityCountReport(Model model, HttpServletRequest request, HttpServletResponse response,
			HttpSession session, @ModelAttribute("reportSchSumm") ReportFilterDto reportFilterBean) {
		return null;
	}
}
